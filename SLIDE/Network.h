...
public:
	...
	int predictClass(const vector<int*> &inputIndices, const vector<float*> &inputValues, int * length, int ** labels, int *labelsize, int numInClass, int numOutClass) const;
